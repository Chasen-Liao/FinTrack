      ...
      {loading ? (
        ...
        <div className="news-list">
          ...
          <div className="sim-target-card">
            <div className="sim-section-label">{t('similar.targetDay')}</div>
          ...
          <div className="sim-stats-card">
            <div className="sim-section-label">{t('similar.historical')} ({data.stats.count} {t('similar.similarDays')})</div>
